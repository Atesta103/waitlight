                                                    ...
                                                    {identity.theme_pattern?.startsWith("food_") && (
                                                        <svg className="absolute inset-0 z-0 w-full h-full opacity-[0.05] text-text-primary" aria-hidden="true">
                                                            <defs><pattern id="preview-motif-mini" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                                                                ...
                                                                {identity.theme_pattern === "food_cutlery" && <g transform="translate(18,18) scale(1)"><path fill="currentColor" d="M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.86 3.75 3.97V22h2.5v-9.03C11.34 12.86 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z" /></g>}
                                                            </pattern></defs>
